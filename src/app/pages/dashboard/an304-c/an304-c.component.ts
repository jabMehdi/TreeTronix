...
@Component({
  selector: 'ngx-an304-c',
  templateUrl: './an304-c.component.html',
  styleUrls: ['./an304-c.component.scss']
})
export class AN304CComponent implements OnInit {
          ...
          this.http.post('/api/sensors/sensor/findByType',
            {
              ...
              this.data.forEach(item => {
                ...
                this.motionStatus = item.data[valeur].motionStatus
              });
            });
        }
      });
