...
export const botReplies = [
  {
    ...
    regExp: /([H,h]hhhh)|([H,h]hhhhhh)|([H,h]hhhhhhhhhhh)/g,
    answerArray: ['ech ydha7ek fik ' , 'seb7a '],
    type: 'text',
    reply: {
      text: '',
      reply: false,
    ...
    regExp: /([W,h]o)/g,
    answerArray: ['am treetronix chat bot ' , 'i am treetronix chat bot'],
    type: 'text',
    reply: {
      text: '',
      reply: false,
  ...
  },
  {
    ...
    answerArray: ['Hey look at this!', 'chbik mareja', 'ched hay taswira', 'Yes, master.'],
    type: 'pic',
    reply: {
      text: '',
      reply: false,
